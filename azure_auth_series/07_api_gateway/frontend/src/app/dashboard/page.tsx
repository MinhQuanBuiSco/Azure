...
const ROLE_CONFIG: Record<string, { color: string; bg: string; description: string }> = {
  Admin: {
    ...
    description: "Full access — manage all tasks in your organization",
  },
  Editor: {
    color: "text-blue-700",
...
function ServiceStatusBadge({ label, status, icon: Icon }: {
  label: string;
  status?: string;
  ...
  const isSuccess = status === "sent" || status === "logged";
  return (
    <Badge
      variant="outline"
      ...
      <div className="space-y-6 md:col-span-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Multi-tenant role-based access control via Azure AD App Roles
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div className="space-y-2">
                {tasks.map((task) => (
                  ...
                  >
                    ...
                    {/* Service-to-service status badges */}
                    <ServiceStatusBadge
                      label="Notify"
    ...
    <div className="container mx-auto max-w-6xl px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Service-to-service auth with OBO and Client Credentials
        </p>
      </div>
          ...
          <CardContent className="flex flex-col items-center gap-4 py-12">
            ...
            <div className="text-center">
              ...
              <p className="mb-4 text-sm text-muted-foreground">
                Sign in with any Microsoft work account to view your
                dashboard
              </p>
            </div>
            <LoginButton />
