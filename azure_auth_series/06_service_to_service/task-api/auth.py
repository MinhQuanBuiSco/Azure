"""
Multi-tenant token validation — same as Blog 5.

Validates user tokens from the SPA frontend. OBO and client credential
flows are handled separately in obo_client.py and service_client.py.
"""
