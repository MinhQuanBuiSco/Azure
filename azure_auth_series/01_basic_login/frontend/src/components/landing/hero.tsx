...
import { ArrowRight, LogIn, Shield, Lock, Globe } from "lucide-react";
      ...
      <div className="relative container mx-auto max-w-6xl px-4 py-24 md:py-32 lg:py-40">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border bg-white/80 px-4 py-1.5 text-sm font-medium text-blue-700 shadow-sm backdrop-blur">
            ...
            Azure Auth Series &mdash; Blog 1
          </div>
          ...
          <p className="mb-10 text-lg text-muted-foreground md:text-xl">
            Learn how to add enterprise-grade authentication to your Next.js app
            using MSAL React. Sign in with your Microsoft account and access
            your profile through the Graph API.
          </p>
