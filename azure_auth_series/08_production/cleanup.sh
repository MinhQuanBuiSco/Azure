...
# ──────────────────────────────────────────────────────
# Blog 8 — Cleanup: Destroy all resources
#
# 1. Terraform destroy (RG + ACR + Container Apps + APIM + App Insights)
...
echo ""
echo "==> This will DESTROY all Blog 8 resources:"
echo "    - Terraform infrastructure (RG, ACR, Container Apps, APIM, App Insights)"
...
echo ""
echo "==> Cleanup complete! All Blog 8 resources destroyed."
